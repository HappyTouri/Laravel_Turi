                ...
                <form action="{{route('user_profile_submit')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" value="{{Auth::guard('web')->user()->name}}" name="name">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" id="password" class="form-control" autocomplete="new-password" value="">
                            </div>
                        </div>
