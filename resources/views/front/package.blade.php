    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>
                    @if(app()->getLocale() === 'ar')
                        {{$package->packageTitle->title_ar}}
                    @elseif(app()->getLocale() === 'ru')
                        {{$package->packageTitle->title_ru}}    
                    @else
                        {{$package->packageTitle->title_en}}    
                    @endif
                    
                </h2>
                <h3><i class="fas fa-plane-departure"></i> {{$package->destination->name}}</h3>
                @if ($package->total_score !=0 ||$package->total_rating !=0 )
                <div class="review">
                    <div class="set">
                        @php
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="tab-7-pane" role="tabpanel" aria-labelledby="tab-7" tabindex="0">
                            ...
                            <div class="enquery-form">
                                <form action="{{route('enquary_form_submit',$package->id)}}" method="post">
                                    @csrf
                                    <div class="mb-3">
                            ...
                            <form action="{{route('payment')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        @endphp
                                        <h2 class="mt_30">
                                            <input type="radio" name="tour_id" value="{{$item->id}}" @if ($i ==1)
                                            checked
                                            @endif >
                                            {{$item->tour_name}} 
                                        </h2>
