    ...
    <body>
        <div class="top">
            <div class="container">
                <div class=" row align-items-center">
                    ...
                    <form action="" class="col-md-2 right-side">
                        <select name="" class="form-select form-select-sm changeLang">
        ...
        <script>
            $('.changeLang').change(function(){
                var url = "{{ route('changeLang') }}"; // The route that handles the language change
                var selectedLang = $(this).val(); // Get the selected language value (en, ru, ar)
                
                // Redirect with the lang parameter
