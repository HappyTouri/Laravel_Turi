                                    ...
                                    <div class="message-item @if($item->type=='Admin') message-item-admin-border @endif">
                                        <div class="message-top">
                                            ...
                                            <div class="right">
                                                ...
                                                <h5>{{ $item->type }}</h5>
                                                <div class="date-time">{{ $item->created_at->format('d M Y, h:i A') }}</div>
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin_message_submit', $id) }}" method="post">
                                    ...
                                    <div class="mb-2">
                                        <textarea name="comment" class="form-control h_150" cols="30" rows="10" placeholder="Write your message here"></textarea>
                                    </div>
                                    <div class="mb-2">
