    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header justify-content-between">
                <h1>Create FAQ of {{$package->packageTitle->title_en}}</h1>
                <div class="ml-auto">
                    <a href="{{route('admin_package_faqs',$package->id)}}" class="btn btn-primary"><i class="fas fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('admin_package_faq_submit',$package->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
