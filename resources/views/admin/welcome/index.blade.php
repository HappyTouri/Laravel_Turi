                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_welcome_item_update', $welcome_item->id) }}" method="post" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"> 
                                            <div class="mb-3">
                                                ...
                                                src="{{ str_replace('watch?v=', 'embed/', strtok($welcome_item->video, '&')) }}" 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" class="form-control editor" id="" cols="30" rows="10">{{$welcome_item->description}}</textarea>
                                    </div>
                                    <div class="mb-3">
