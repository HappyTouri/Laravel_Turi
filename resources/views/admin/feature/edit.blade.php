            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin_feature_edit_submit', $feature->id) }}" method="post" >                                    @csrf
                                    <div class="mb-3"> 
                                    ...
                                    <div class="mb-3"> 
                                        ...
                                        <div><input type="text" class="form-control" name="icon" value="{{$feature->icon}}"></div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" class="form-control h_100" id="" cols="30" rows="10">{{$feature->description}}</textarea>
                                    </div>
