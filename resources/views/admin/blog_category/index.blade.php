...
<div class="main-content">
    <section class="section">
        <div class="section-header justify-content-between">
            ...
            <div class="ml-auto">
                <a href="{{route('admin_blog_category_create')}}" class="btn btn-primary"><i class="fas fa-plus"></i>
                    Add New</a>
            </div>
        </div>
                                ...
                                <table class="table table-bordered" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$blog_category->name_en}}</td>
                                            <td>{{$blog_category->name_ru}}</td>
                                            <td>{{$blog_category->name_ar}}</td>
