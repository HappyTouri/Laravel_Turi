            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin_testimonial_edit_submit', $testimonial->id) }}" method="post" enctype="multipart/form-data">                                    @csrf
                                    <div class="mb-3"> 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="comment" class="form-control h_100" id="" cols="30" rows="10">{{$testimonial->comment}}</textarea>
                                    </div>
